...
import { DeepseekAiClient, I18n } from "@cat-i18n/maine-coon";
...
async function startServer() {
  try {
    ...
    const apiAdapter = new ExpressAdapter(
      i18n,
      new DeepseekAiClient("sk-PZFrVOT6WMYwdXEm26m6lNvuDupcAzLS", {
        baseUrl: "https://api.proxyapi.ru/deepseek/chat/completions",
      }),
      {
