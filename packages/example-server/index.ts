...
// Пример использования I18n с MongoDBAdapter
...
async function main() {
  try {
    ...
    console.log("Кеш включен:", i18n.isCacheEnabled());

    // Отключение кеша
    i18n.setCacheEnabled(false);
    console.log("Кеш включен после отключения:", i18n.isCacheEnabled());

    // Повторное включение кеша
